...
import java.util.List;
    ...
    public void start(Future<Void> startFuture) throws Exception
    {
        ...
        camConfig.withRotation(new JsonQuaternion(0.67265f,0.0f,0.0f,0.7399f))
    ...
    public CameraConfig CreateCameraConfig() {
        CameraConfig camConfig = new CameraConfig()
                .withLocation(new JsonPoint(33.0f, 165.0f, 54.0f))
                .withRotation(new JsonQuaternion(0.67265f,0.0f,0.0f,0.7399f))
                .withLookAt(new JsonPoint(0.0f, 0.0f, 0.0f));
        return camConfig;
    }
    ...
    public WorldConfig CreateWorld()
    {
        ...
        rRegionList.add(CreateRegion("StudentsCafeteria",61f,73f,55f,69f));
