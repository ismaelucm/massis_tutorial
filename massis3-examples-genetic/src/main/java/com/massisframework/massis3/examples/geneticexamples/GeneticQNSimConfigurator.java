...
public class GeneticQNSimConfigurator {
    ...
    public static float defaultMinMutationRate = 0.1f;
    public static float defaultMaxMutationRate = 0.8f;
    ...
    public static int defaultPopulationSize = 2000;
    public static int[] experimentsID = new int[]{0,1,2,3};
    public static int validationExperimentID = 4;
    ...
    public static void CreateExperiments()
    {
        ...
        final String dafaulSimulationResult01 = currentPath+"/massis3-examples-genetic/src/main/resources/Entrada_Clase.txt";
        final String defaultSolutionFileOutput01 = currentPath+"/SolutionQNexp01.txt";
        final String defaulScene01 = currentPath+"/massis3-examples-genetic/src/main/resources/SceneExample.xml";
        _experiments[0] = new Experiment(dafaulSimulationResult01,defaultSolutionFileOutput01,defaulScene01);

        final String dafaulSimulationResult02 = currentPath+"/massis3-examples-genetic/src/main/resources/Evacuacion_exp02.txt";
        final String defaultSolutionFileOutput02 = currentPath+"/SolutionQNexp02.txt";
        final String defaulScene02 = currentPath+"/massis3-examples-genetic/src/main/resources/SceneExample02.xml";
        _experiments[1] = new Experiment(dafaulSimulationResult02,defaultSolutionFileOutput02,defaulScene02);

        final String dafaulSimulationResult03 = currentPath+"/massis3-examples-genetic/src/main/resources/exp03.txt";
        final String defaultSolutionFileOutput03 = currentPath+"/SolutionQNexp03.txt";
        final String defaulScene03 = currentPath+"/massis3-examples-genetic/src/main/resources/SceneExample03.xml";
        _experiments[2] = new Experiment(dafaulSimulationResult03,defaultSolutionFileOutput03,defaulScene03);

        final String dafaulSimulationResult04 = currentPath+"/massis3-examples-genetic/src/main/resources/exp04.txt";
        final String defaultSolutionFileOutput04 = currentPath+"/SolutionQNexp04.txt";
        final String defaulScene04 = currentPath+"/massis3-examples-genetic/src/main/resources/SceneExample04.xml";
        _experiments[3] = new Experiment(dafaulSimulationResult04,defaultSolutionFileOutput04,defaulScene04);

        final String dafaulSimulationResult05 = currentPath+"/massis3-examples-genetic/src/main/resources/exp05.txt";
        final String defaultSolutionFileOutput05 = currentPath+"/SolutionQNexp05.txt";
        final String defaulScene05 = currentPath+"/massis3-examples-genetic/src/main/resources/SceneExample05.xml";
