...
public class SimulationNode {
    ...
    public void setTimeToCrossBlocked(boolean b) {
        _timeToCrossBlocked = b;
    }
    ...
    public SimulationNode(NodeConfig nodeConfig) {
        ...
        _timeToCrossNode = nodeConfig.getTimeToCrossTheNode();
        _capacityBlocked = nodeConfig.isBlockCapacity();
        _timeToCrossBlocked = nodeConfig.isBlockTime();
    }
    ...
    public int getTimeToCrossNode() {
        return _timeToCrossNode;
    }

    public void setTimeToCrossNode(int f) {
        _timeToCrossNode = f;
    }
