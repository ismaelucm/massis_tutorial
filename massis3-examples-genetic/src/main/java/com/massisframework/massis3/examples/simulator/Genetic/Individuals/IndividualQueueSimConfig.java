...
public class IndividualQueueSimConfig extends IndividualGAL {
    ...
    protected void initialize()
    {
        ...
        for (int i = 0; i < _timeGenotype.length; ++i) {
            _timeGenotype[i] = Dice.GetRange(SimulationNode.MIN_TIME_TO_CROSS,SimulationNode.MAX_TIME_TO_CROSS);
        }
    ...
    public int timeRandValue() {
        return Dice.GetRange(SimulationNode.MIN_TIME_TO_CROSS, SimulationNode.MAX_TIME_TO_CROSS);
    }
    ...
    public int getDomineLayer(int layer)
    {
        if(layer == 0)
            ...
            return SimulationNode.MAX_TIME_TO_CROSS-SimulationNode.MIN_TIME_TO_CROSS;
        else if(layer == 2)
